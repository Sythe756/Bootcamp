...
#     print("O has won!")
#     return 'O'
#   elif gameBoard[0][0] == 'X' and gameBoard[1][1] == 'X' and gameBoard[1][2] == 'X':
#     print("X has won!")
#     return 'X'
#   elif gameBoard[0][2] == 'X' and gameBoard[1][1] == 'X' and gameBoard[2][0] == 'X':
#     print("X has won!")
#     return 'X'
#   elif gameBoard[0][2] == '0' and gameBoard[1][1] == 'O' and gameBoard[2][0] == 'O':
#     print("O has won!")
#     return 'O'
